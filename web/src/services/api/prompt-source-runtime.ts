...
function makePrompt(input: { id: string; title: string; prompt: string; coverUrl?: string; videoUrl?: string; modality?: string; tags?: string[]; preview?: string; createdAt?: string; updatedAt?: string }): RawPrompt {
    return {
        id: input.id,
        title: input.title,
        prompt: input.prompt,
